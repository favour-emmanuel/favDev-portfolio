...
const ProjectPage = () => {
  ...
  const portfolioItems: portfolio[] = [
    ...
    },
    {
      ...
      label:
        "A modern real estate site offering a seamless experience for browsing and purchasing properties, with features such as interactive maps, customizable search filters, and expert advice to guide users through every step of their real estate journey.",
      tools: ["React", "Typescript", "Tailwindcss"],
  ...
  return (
    ...
    >
      <div>
        ...
        <p className="font-light text-sm lg:text-base w-full lg:max-w-[42rem]">
      ...
      <div className="absolute right-0 bottom-4 top-0">
        <img src={lineBg} alt="" />
      </div>

      <div className="grid lg:grid-cols-3 grid-cols-1"></div>
    </div>
  );
};
